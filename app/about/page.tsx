...
import { getCabinsCount } from "../_lib/data-service";
...
export default async function Page() {
	const cabinsCount = await getCabinsCount();
	console.log(cabinsCount);
	return (
		<div className="text-lg py-12 mx-5 items-center">
			<div className="flex flex-col md:flex-row mb-10 items-center gap-4">
				<div>
					...
					<div className="space-y-8">
						<p>
							...
							Hidden away in the heart of the Egypt (Lake Qarun), this is your
